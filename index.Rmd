...
<img id="myImg" src="images/logo.png" alt="The Gannet logo"/>

::: release
<h3>Current stable release: <a href="https://github.com/markmikkelsen/Gannet" target="_blank" class="badge badge-secondary">3.3.0</a></h3>
:::
...
Gannet is continually being updated and has an active support base. Visit our <a href="https://gabamrs.com/" target="_blank">blog</a> for the latest news on Gannet and our developments in edited MRS methodology.
...
The simplest way to install Gannet is to download the zipped [main directory](https://github.com/markmikkelsen/Gannet/archive/refs/heads/main.zip) from the <a href="https://github.com/markmikkelsen/Gannet" target="_blank">repository</a> on GitHub, unzip it, and move the `Gannet-main/` directory into your MATLAB directory (or anywhere of your choice).
...
The support team can also be directly reached using our blog's <a href="https://gabamrs.com/contact" target="_blank">contact form</a>. We will do our best to work with you to solve your issue.
