...
Gannet is currently being developed in MATLAB R2023b in macOS 14 Sonoma (Apple silicon M1). While reasonable effort is made to ensure legacy and cross-OS compatibility, an error-free user experience is not guaranteed.
