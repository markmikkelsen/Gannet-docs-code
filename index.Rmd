...
<img class="img-50" src="images/logo+title_2026.png" alt="The Gannet logo"/>

::: release
<h3>Current stable release: <a href="https://github.com/markmikkelsen/Gannet" target="_blank" class="badge badge-secondary">3.5.4</a></h3>
:::
...
To run the voxel co-registration and structural image segmentation modules, <a href="https://www.fil.ion.ucl.ac.uk/spm/software/spm12/" target="_blank">SPM12</a> must be installed (see [Dependencies](#dependencies)).
...
::: warning
<i class="fa fa-exclamation-circle" style="color: white"></i> If you have <a href="https://github.com/schorschinho/osprey" target="_blank" style="color:white"><u>Osprey</u></a> also installed on your computer, please ensure that on your search path you either have placed all the Gannet directories at the top (so that they take precedence) or have removed the Osprey directories. Gannet and Osprey historically have shared some functions that may lead to conflicts, resulting in Gannet not functioning correctly.
:::

### Dependencies

Gannet uses a few third-party software packages that are required for additional functionality.

**SPM12**

SPM12 is required for several core functionalities within Gannet, including voxel co-registration and image segmentation. It can be downloaded from the <a href="https://www.fil.ion.ucl.ac.uk/spm/software/spm12/" target="_blank">SPM12</a> website.

It must be installed and added to MATLAB's search path as described in [Setup](#setup).
...
Users may append their PDF outputs into single PDF files using Ghostscript. To do this, Ghostscript must be installed and available on your system. Download Ghostscript from the <a href="https://www.ghostscript.com/download/gsdnld.html" target="_blank">official website</a>. macOS users can download a compatible version <a href="https://pages.uoregon.edu/koch/" target="_blank">here</a>.

Alternatively, macOS users may install Ghostscript using Homebrew with the following command:
...
Gannet is developed in MATLAB R2026a in macOS 26 Tahoe (Apple silicon). While reasonable effort is made to ensure legacy and cross-OS compatibility, an error-free user experience is not guaranteed.
...
If you encounter any problems, please first check the Documentation or [FAQ](./faq.html) for a solution.
...
The Gannet team can also be <a href="mailto:mark.mikkelsen@gmail.com?subject=[Gannet]%20<Please enter the subject of your query here>" target="_blank">contacted</a> directly. We will do our best to work with you to solve your issue.
...
This software is licensed under an open-source [BSD-3-Clause License](./gannet-license.html). Should you disseminate material that made use of Gannet, please cite the following publications, as appropriate:
