...
Conventional (or arithmetic) averaging is straightforward. All sequentially acquired $n$ pairs of subspectra $x_i$ (e.g., all edit-ON and edit-OFF subspectra) are averaged using the arithmetic mean: $\bar{x} = \frac{1}{n}\sum_{i=1}^nx_i$.
