...
<img class="img-75" src="images/additional-tools/paperplot-1.png" alt="Example output of PaperPlot.m">

```{octave, eval = FALSE}
PaperPlot(MRS, 'plotModel', true); % Overlay fit models
```

<img class="img-75" src="images/additional-tools/paperplot-2.png" alt="Example output of PaperPlot.m">
...
<img class="img-75" src="images/additional-tools/paperplot-3.png" alt="Example output of PaperPlot.m">
...
Please <a href="mailto:mark.mikkelsen@gmail.com?subject=[Gannet]%20<Please enter the subject of your query here>" target="_blank">contact us</a> if you require a de-identification tool for a different format.

::: warning
<i class="fa fa-exclamation-circle" style="color: white"></i>&nbsp; <strong>IMPORTANT:</strong> De-identification is a complex process, and it is your responsibility to ensure that all PHI/PII is removed from your data. The Gannet de-identification functions are designed to remove the most common PHI/PII identifiers, but they may not catch everything. Always double-check your data after de-identification to ensure that no sensitive information remains.
<ul>
  ...
  <li>Per our <a href="./gannet-license.html" target="_blank" style="color:white"><u>software license</u></a>, the Gannet developers are not liable for any failure of our de-identification routines to remove PHI/PII from your data.</li>
</ul>
:::
...
Should the regulations in your country or institution require additional information to be removed, please <a href="mailto:mark.mikkelsen@gmail.com?subject=[Gannet]%20<Please enter the subject of your query here>" target="_blank">contact us</a>.
