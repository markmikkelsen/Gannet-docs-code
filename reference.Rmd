...
C) Textual results from GannetFit (full details can be found on the [Data quality metrics](./data-quality-metrics.html) page). For the metabolites listed:
    ...
    - Quantification details can be found on the [Quantification & tissue correction](./quantification-tissue-correction.html) page.
...
B) Textual details of the CSF-corrected metabolites values (see [Quantification & tissue correction](./quantification-tissue-correction.html) for further details) and the voxel tissue volume fractions.
...
C) Textual details of tissue-corrected metabolite values (see [Quantification & tissue correction](./quantification-tissue-correction.html) for further details).
