...
| `seqorig` | Origin of Philips MEGA-PRESS or GE HERMES sequences |
...
| `append`   | Set to `1` to append PDF outputs into one PDF (separately for each module) (requires `export_fig` in the Gannet directory to be added to the search path and Ghostscript to be installed) |
