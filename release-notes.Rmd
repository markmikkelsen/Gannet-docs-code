...
## 3.5.4
<span style="color: grey;">2026-07-31</span>

### What's changed

* Added lower/upper bounds for signal model fitting in `FitChoCr.m`
* In `GERead.m`, `LarmorFreq` is now read as an unsigned integer (fix for data acquired on 7T scanners)
* Better handling of multidimensional cell-array inputs
* Better handling of Siemens .rda file joining
* Better parsing of Siemens .rda file headers in `SiemensRead.m`
* Refinement of GitHub Actions workflows
* Updated Gannet logo

**Full changelog**: <a href="https://github.com/markmikkelsen/Gannet/compare/v3.5.3...v3.5.4" target="_blank">`v3.5.3...v3.5.4`</a>

## 3.5.3
<span style="color: grey;">2026-02-06</span>

### What's changed

* Enhanced montage labeling in `GannetQuantify.m`
* Updated MRIQC metrics to use median absolute deviation (MAD) and improve robustness

**Full changelog**: <a href="https://github.com/markmikkelsen/Gannet/compare/v3.5.2...v3.5.3" target="_blank">`v3.5.2...v3.5.3`</a>
...
**Full changelog**: <a href="https://github.com/markmikkelsen/Gannet/compare/v3.5.1...v3.5.2" target="_blank">`v3.5.1...v3.5.2`</a>
...
- Gannet is now compatible with <a href="https://bids-specification.readthedocs.io/en/stable/" target="_blank">BIDS</a>
  - [`bids-matlab`](https://bids-matlab.readthedocs.io/en/main/), a MATLAB toolkit for interfacing with BIDS datasets, is embedded in Gannet, and users can now input BIDS datasets directly into `GannetLoad.m` (see [documentation](./getting-started.html#compatibility-with-bids) for usage instructions)
