...
::: info
<i class="fa fa-info-circle" style="color: white"></i>&nbsp; When encountering an error or bug in Gannet, please first check you are using the latest <a href="https://github.com/markmikkelsen/Gannet" target="_blank" style="color:white"><u>version</u></a>. It may be that your issue has already been addressed.
:::
