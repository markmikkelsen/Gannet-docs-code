...
<script src="js/hide-output.js"></script>

<br>

<div class="warning">
<i class="fa fa-exclamation-circle" style="color: white"></i>&nbsp;&nbsp; These examples were created in release 3.2.0. Be careful copy-pasting these example settings into your version of `GannetPreInitialise.m`. You may be using a different release that has older/newer variables that could result in an error during the analysis pipeline.
</div>

## Philips data {.tabset .tabset-fade .tabset-pills}
