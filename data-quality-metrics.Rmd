...
Uses the Shannon entropy of voxel intensities as an indication of ghosting and blurring induced by head motion. Low values are better.
...
The average energy of image voxel intensities within the head relative to outside the head. Higher values are better, and an FBER = -1 indicates that there is no signal outside the head mask (e.g., a skull-stripped dataset).
