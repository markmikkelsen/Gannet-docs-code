...
| :- | :--------- |
| `version` | A structure containing release numbers of Gannet and the Gannet modules |
...
| `img_montage` | Cell array containing three-dimensional arrays representing a montage of axial alices of the T1 images overlaid by the tissue-segmented voxel masks |
