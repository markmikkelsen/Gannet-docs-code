...
`nrows` | Total number of individual averages of each input file |
`Navg` | Total number of individual averages of each input file |
`TE` | Echo time (m) |
`TR` | Repetition time (ms) |
`voxdim` | Array of voxel dimensions (mm) |
`voxoff` | Array of voxel position offset (mm) |
`voxang` | Array of voxel angulation (deg) |
`Nwateravg` | Total number of individual averages of each input water reference file |
